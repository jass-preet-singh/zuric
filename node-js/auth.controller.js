  ...
  await fs.readFile('app/public/json/quiz.json', function (err, result) {
    ...
    results.forEach(element => {
      if (element.id == uid) {
        ...
        element.answer.option1 = req.body.option1
        element.answer.option2 = req.body.option2
        element.answer.option3 = req.body.option3
        element.answer.option4 = req.body.option4
        element.answer.correctAns = req.body.correctAns
      }
    });
